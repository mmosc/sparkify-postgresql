...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplay_table (songplay_id int, start_time numeric, user_id int, level varchar, song_id int, artist_id int, session_id int, location varchar, user_agent varchar);"
